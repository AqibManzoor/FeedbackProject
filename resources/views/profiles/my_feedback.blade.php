                                                                                        ...
                                                                                        <div class="d-flex flex-column comment-section">
                                                                                            <div class="bg-white p-2">
                                                                                                <div class="d-flex flex-row user-info"><img class="rounded-circle" src="https://i.imgur.com/RpzrMR2.jpg" width="40">
                                                                                                    <div class="d-flex flex-column justify-content-start class=" d-block ml-2"><span font-weight-bold name">{{$feedback->created_by->name??''}}</span><span class="date text-black-50">{{$feedback->created_at}}</span></div>
                                                                                                </div>
                                                                                                <div class="mt-2">
                                                                                                    <p class="comment-text">{{ substr($feedback->description,0,10) }}.</p>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="bg-white">
